package utechandroid.com.radio.util.Colors;
...
public enum AccentColor implements Parcelable {
    ...
    BROWN_A100("Brown A100", R.style._ColorsTheme_Accent_Brown_A100, R.color._color_lib_brown_A100),
    BROWN_A200("Brown A200", R.style._ColorsTheme_Accent_Brown_A200, R.color._color_lib_brown_A200),

    BLUE_GREY_A100("BlueGrey A100", R.style._ColorsTheme_Accent_BlueGrey_A100, R.color._color_lib_blue_grey_A100),
    BLUE_GREY_A200("BlueGrey A200", R.style._ColorsTheme_Accent_BlueGrey_A200, R.color._color_lib_blue_grey_A200);
